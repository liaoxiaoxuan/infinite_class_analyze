...
1. 《詩話總龜》前集引用詩話分析  
    ...
    + 文字雲  
        從圖片結果，可以一目瞭然《古今詩話》是《詩話總龜》前集當中，引用次數最多的資料來源，其次是《詩史》，其他如《青葙雜記》、《冷齋夜話》、《談苑》、《王直方詩話》等，也是引用次數較為突出者。  
        ![fig1](./src/book_wc.png)  
    
    + 長條圖  
        透過長條圖的圖示和數字，更可以明確得知，《古今詩話》引用次數高達 132 次，近乎是次高的《詩史》的三倍。
...
2. 《紅樓夢》和《三國演義》詞向量表示和相似度計算：**Word2Vec**  應用  
    ...
    **2-1. 《紅樓夢》**  
    ...
    + 詞向量表示  
        若僅採用小說中人物的姓名進行分析，可見賈惜春和秦可卿之間的距離最近。其他距離較近的前十人，依序如下：  
        ```
    ...
    + 餘弦相似度  
        若僅採用小說中人物的姓名進行分析，可見林黛玉和賈惜春之間的 cosine similarity 最近。其他距離較近的前十人，依序如下：  
        ```
    ...
    **2-2. 《三國演義》**  
    ...
    + 詞向量表示  
        若僅採用小說中人物的姓名進行分析，可見賈孫權和司馬懿之間的距離最近。其他距離較近的前十人，依序如下：  
        ```
    ...
    + 餘弦相似度  
        若僅採用小說中人物的姓名進行分析，可見諸葛亮和關羽之間的 cosine similarity 最近。其他距離較近的前十人，依序如下：  
        ```
...
3. 《紅樓夢》和《三國演義》人際網絡圖：**Social networks** 應用  
    ...
    **3-1. 《紅樓夢》**  
        匯入人名和地名字典之後，將《紅樓夢》進行斷詞，並生成書中賈寶玉和十二金釵等主要人物之間的人際網絡圖。從圖中可見分析的人物當中，鳳姐和是和所有人有最多交集的，其次是寶玉，再其次是黛玉和寶釵。  
          
     ![fig5](./src/hongxue_networks.png)
    
    **3-2. 《三國演義》**  
        匯入人名和地名字典之後，將《三國演義》進行斷詞，並生成書中諸葛亮和三國主要人物之間的人際網絡圖。從圖中可見分析的人物當中，曹操和是和所有人有最多交集的，其他人則是不分軒輊。  
...
2. 古人稱呼的多樣性  
    ...
    + 後續修正與相關貢獻
        ...
        - 可以再進一步探討，同一個人物，不同稱謂出現的時刻，進而統整出古人這些多元稱呼的運用時機。  

3. 運用程式進行資料分析與傳統的研究方法之異同

    + 參考資料來源  
    撰寫程式的時候，除了參考網路上諸多網誌的作品以外，也會借用 ChatGPT 的力量，完成和理解這些程式；然而，這些作品，尤其是 ChatGPT，都需要再經過驗證與考據，才能判斷這些作法是否可行、資料是否可信。而傳統研究上，縱使有網路檢索，但資料來源是在查找的過程，就會由作者、作者擅長領域、出版社等方面，進行篩選，以提高研究成果的品質。

    + 資料運用方式  
    在文史領域的傳統研究，比較傾向質性研究，透過文本的解讀、前人的研究成果和時代背景的理解等交互參照，以印證假說。而程式的加入，透過模型的計算，以及圖表的呈現，進一步讓研究成果更加具體。甚至藉由數位工具的協助，大幅增加需要量化的數據與資料的結果的增加便利性。